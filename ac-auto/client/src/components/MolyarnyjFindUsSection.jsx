/**
 * «Как нас найти» для малярки: ул. Космическая 2А, карта + иконки 2ГИС и Яндекс.
 */
...
export function MolyarnyjFindUsSection() {
  const tel = phoneTelHref(PHONE_DISPLAY);

  return (
    <section className="bg-neutral-100 py-14 md:py-20" aria-labelledby="molyarnyj-find-title">
        ...
        <div className="flex flex-col gap-10 md:flex-row md:items-stretch md:gap-12 lg:gap-14">
          <div className="min-h-0 w-full shrink-0 md:w-[min(100%,28rem)] md:flex-1 lg:max-w-none">
            <div className="overflow-hidden rounded-xl bg-neutral-200 shadow-sm ring-1 ring-neutral-200/80">
              <iframe
                title="Карта: малярно-кузовной цех, Оренбург, ул. Космическая 2А"
                src={MAP_WIDGET_SRC}
                width="100%"
                height="360"
          ...
          <div className="flex flex-col justify-center md:min-w-0 md:flex-1">
            <h2
              id="molyarnyj-find-title"
              className="text-base font-bold uppercase tracking-[0.1em] text-[#1c4d9e] md:text-lg"
            >
              Как нас найти
            </h2>
