...
export function RostoshCarwashLeadFormSection() {
  const formId = useId();
  const titleId = `${formId}-rostosh-carwash-lead-title`;
  ...
  async function onSubmit(e) {
    ...
    try {
      await createApplication({
        ...
        name: name.trim(),
        phone: phone.trim(),
        message: "Заявка: автомойка и детейлинг ROSTOSH",
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-lg px-4 md:px-6">
        ...
        >
          Хотите воспользоваться услугами нашей сети автомоек или детейлинг-сервиса?
        </h2>
