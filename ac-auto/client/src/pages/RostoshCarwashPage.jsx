...
/** Лендинг автомойки / детейлинга: /rostosh_carwash */
export default function RostoshCarwashPage() {
    ...
    <>
      <div className="w-full bg-neutral-950">
        <section
          ...
          aria-labelledby="rostosh-carwash-hero-title"
        >
          <div
